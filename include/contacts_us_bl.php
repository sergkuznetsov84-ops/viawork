<section class="comp-93 style-1 is-dark">
  ...
  <picture>
    ...
    <img src="<?=SITE_TEMPLATE_PATH.'/src/img/comp-93-gorsel-wp.jpg'?>" class="sp-no-webp" alt="">
  </picture>
</div>
  ...
  <picture>
    ...
    <img src="<?=SITE_TEMPLATE_PATH.'/src/img/comp-93-proje.jpg'?>" class="sp-no-webp" alt="">
  </picture>
</div>
                <div class="card-content">
                  <div class="text">
                    <p>Хотите стать нашим дилером?</p>
                  </div>
                  <div class="action">
                    <a href="/contact/" class="btn btn-white btn-rnd-full btn-medium btn-gradient" target="">
                      Связаться
...
<div class="card-media">
  <picture>
    ...
    <img src="<?=SITE_TEMPLATE_PATH.'/src/img/comp-93-calma.jpg'?>" class="sp-no-webp" alt="">
  </picture>
</div>
                <div class="card-content">
                  <div class="text">
