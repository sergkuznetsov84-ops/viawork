...
<section class="comp-10 is-download">
			...
			<div class="row">
				<div class="col-xl-10 offset-xl-1">
					<div class="comp-10-main">
						...
						<?if($arParams["DISPLAY_TITLE"] != "N" && !empty($arResult["NAME"])):?>
						<div class="comp-10-head">
							<div class="comp-10-head-title fadeInUp-scroll visible" data-delay="100">
							...
							<div class="swiper">
								<div class="swiper-wrapper">
									<?foreach($arResult["ITEMS"] as $arItem):?>
										...
										// Данные элемента
										$link = $arItem["DISPLAY_PROPERTIES"]["FILE"]["FILE_VALUE"]["SRC"] ?? $arItem["DISPLAY_PROPERTIES"]["FILE"]["VALUE"];
										...
										<div class="swiper-slide" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
											<a href="<?=$link?>" class="comp-10-item fadeInUp-scroll visible" data-delay="150" download>
												...
												<div class="comp-10-item-media">
													<picture>
														...
														<img src="<?=$img?>" class="media-fluid sp-no-webp" alt="<?=htmlspecialcharsbx($title)?>">
													</picture>
												</div>
											</a>
										</div>
