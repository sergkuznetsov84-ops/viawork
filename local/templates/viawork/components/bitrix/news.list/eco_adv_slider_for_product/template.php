				...
				<div class="row" >
					<div class="col-xl-10 offset-xl-1" >
						<div class="comp-22-cta-main fadeInUp-scroll" data-delay="100" >
							<h4>Послушайте рассказ компании Nurus о её пути к устойчивому развитию.</h4>
							<a href="<?=$arParams["METOO_HREF"]?>" target="" class="btn btn-white btn-semibold btn-rnd-full"><span>Посетите нашу страницу</span> <i>
	<svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
