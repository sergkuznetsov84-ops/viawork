...
<div class="bx_filter <?=$templateData["TEMPLATE_CLASS"]?> bx_horizontal">
	<div class="bx_filter_section">	
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="filter-form smartfilter">
			...
			<div class="filter-boxes-wrap">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="bx_filter_parameters_box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?><?endif?>">
						<span class="bx_filter_container_modef"></span>
						<div class="bx_filter_parameters_box_title" onclick="smartFilter.hideFilterProps(this)"><?=$arItem["NAME"]?></div>
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								case "P"://DROPDOWN
									...
									?>
									<!-- <select name="" data-class-modif="">
										<option value="" selected>Грузоподъемность</option>
										<option value="2">30 т</option>
										<option value="3">40 т</option>
										<option value="4">60 т</option>
										<option value="4">80 т</option>
										<option value="4">100 т</option>
									</select> -->
