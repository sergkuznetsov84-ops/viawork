...
?>
			...
			<div class="col-6 col-lg-3 order-0">
					<div class="comp-105-filters-main">
						<div class="comp-105-filters-main-btn ">
							<a href="javascript:;">
								<i class="filter-icon">
						...
						<div class="comp-105-filters-body">
							<div class="bx_filter row">
								<div class="bx_filter_section">
									<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
										...
										foreach($arResult["ITEMS"] as $key=>$arItem)
										{
											...
											if (
												...
												continue;
											?>
											<div class="comp-105-filters-body-item <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif?> <?foreach($arItem["VALUES"] as $val => $ar){ if ($ar["CHECKED"]){ echo 'checked'; break;}}?>">
												<span class="bx_filter_container_modef"></span>
												<div class="comp-105-filters-body-item-title" onclick="smartFilter.hideFilterProps(this)"><?=$arItem["NAME"]?>
									...
									<div class="comp-105-filters-body-mobile">
									<div class="comp-105-filters-body-mobile-selected-filters"></div>
									<div class="comp-105-filters-body-mobile-head">
										<div class="title">
											<i>
												<svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17" fill="none">
													...
													<path d="M7.02935 10.1262C8.71166 10.1262 10.0763 11.4908 10.0763 13.1732C10.0763 14.8555 8.71166 16.2201 7.02935 16.2201C5.34704 16.2201 3.981052 14.8555 3.981052 13.1732C3.981052 11.4908 5.34704 10.1262 7.02935 10.1262Z" stroke="#25282A" stroke-width="1.44404" stroke-linecap="round" stroke-linejoin="round"></path>
												</svg>
											</i>
									...
									<div class="comp-105-filters-body-mobile-content">
										<?foreach($arResult["ITEMS"] as $key=>$arItem):
										...
										?>
											<div class="comp-105-filters-body-mobile-content-item">
												<div class="comp-105-filters-body-mobile-content-item-head">
												...
												<div class="comp-105-filters-body-mobile-content-item-list">
													<div class="list-head">
														<div class="back-btn">
															<a href="javascript:;">
																<i>
									...
									<div class="comp-105-filters-body-mobile-footer">
										<div class="apply-btn">
			...
			<div class="col-lg-3 col-xl-2 d-none d-lg-block" bis_skin_checked="1">
				<div class="comp-105-filters-download-btn" bis_skin_checked="1">
					<a href="javascript:;" id="download-selected">
						<span>Download <b id="selected-count">0</b> Files</span>
						<i>
			...
			<div class="col-lg-3 col-xl-2 d-lg-block d-none ms-lg-auto" >
				<div class="comp-24-filters-search" >
					<form action="">
						<input type="text" id ="element-search" placeholder="Поиск" name="arrFilter1[?NAME]" value="<?= $_REQUEST['arrFilter1']['?NAME'] ?>" onkeyup="debouncedUpdate(this.value)">
								...
								function updateUrlParam(value) {
									...
									if (value.trim()) {
										url.searchParams.set('arrFilter1[?NAME]', value.trim());
									} else {
										url.searchParams.delete('arrFilter1[?NAME]');
									}
	...
	<div class="comp-24-body" style="display:none;" >
		<div class="row" >
			<div class="col-12" >
