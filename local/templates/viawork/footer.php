...
document.addEventListener("click", function(event) {
    const burger = event.target.closest(".header .header-bars");
    if (!burger) {
        return;
    }
    ...
    const currentHeader = burger.closest(".header");
    const isOpen = currentHeader.classList.contains("show");
    ...
    document.querySelectorAll(".header .language-btn.active").forEach(function(button) {
        button.classList.remove("active");
    });
    document.querySelectorAll(".header .language-dropdown.show").forEach(function(dropdown) {
        dropdown.classList.remove("show");
    });
    document.querySelectorAll(".header .search-btn.active").forEach(function(button) {
        button.classList.remove("active");
    });
    document.querySelectorAll(".header .search-dropdown.show").forEach(function(dropdown) {
        dropdown.classList.remove("show");
    });

    currentHeader.classList.toggle("show", !isOpen);
...
document.addEventListener("click", function(event) {
    const closeButton = event.target.closest(".header .header-bars-right");
    if (!closeButton) {
        return;
    }
    ...
    const currentHeader = closeButton.closest(".header");
    if (!currentHeader) {
        return;
    }

    currentHeader.classList.remove("show", "mobile-dropdown");
    currentHeader.querySelectorAll(".nav-list-item-link.active").forEach(function(link) {
        link.classList.remove("active");
    });
    currentHeader.querySelectorAll(".nav-list-item-dropdown.show").forEach(function(dropdown) {
        dropdown.classList.remove("show");
    });
    ...
    currentHeader.querySelectorAll(".nav-list-item-dropdown-item-body-mobile.show").forEach(function(panel) {
