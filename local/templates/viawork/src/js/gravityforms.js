            ...
            ? (r[i].splice(o, 1),
              ...
              0 === (o = r[i].length)
                  ...
                  : (jQuery("#error_" + a).remove(),
                    o < t.gf_vars.max_files && gfMultiFileUploader.toggleDisabled(t, !1)))
            : (r[i] = null),
...
void 0 === jQuery.fn.prop && (jQuery.fn.prop = jQuery.fn.attr),
            ...
            jQuery(e)
                ...
                .on("change keyup", function () {
                    void 0 === jQuery(this).attr("onChange") && void 0 === jQuery(this).attr("onClick") && (t = !0),
                        "enable-api" === (jQuery(this).next().data("jsButton") || jQuery(this).data("jsButton")) &&
                            (t = null);
                }),
    ...
    (gform.tools = {
        ...
        getNodes: function (e, t, r, i) {
            return e
                ? ((r = (r = this.defaultFor(r, document)).querySelectorAll(i ? e : '[data-js="' + e + '"]')),
...
function gformGetShippingPrice(e) {
    ...
    return gformToNumber(
        (t = 1 != e.length || gformIsHidden(e) ? t : e.attr("readonly") ? e.val() : gformGetPrice(e.val()))
    );
}
    ...
    0 < n.length
        ...
        : ((r = 1),
          0 < (n = jQuery(".gfield_quantity_" + e + "_" + t + " :input")).length &&
              ((r = n.val()), (i = gf_get_field_number_format(gf_get_input_id_by_html_id(n.attr("id")), e, "value"))));
...
function gformFormatPricingField(e) {
    ...
    gf_global.gf_currency_config &&
        ((t = new gform.Currency(gf_global.gf_currency_config).toMoney(jQuery(e).val())), jQuery(e).val(t));
}
...
function gformGetProductIds(e, t) {
    for (
        var r = (jQuery(t).hasClass(e) ? jQuery(t) : jQuery(t).parents("." + e)).attr("class").split(" "), i = 0;
        i < r.length;
        i++
    )
...
function gformAddListItem(e, t) {
    ...
    e.hasClass("gfield_icon_disabled") ||
        ...
        r.find("input, select, textarea").attr("tabindex", n).not(":checkbox, :radio").val("").attr("value", ""),
...
function gformDeleteListItem(e, t) {
    ...
    e.prop("disabled") ||
        (e.prop("disabled", !0),
        (r = (e = e.parents(".gfield_list_group")).parents(".gfield_list_container")),
        e.remove(),
...
function gformToggleIcons(e, t) {
    ...
    1 === r
        ? e.find(".delete_list_item").prop("disabled", !0).css("visibility", "hidden")
        : e.find(".delete_list_item").prop("disabled", !1).css("visibility", "visible"),
        0 < t && t <= r
                                  ...
                                  .each(function () {
                                      ...
                                      if (void 0 !== t) {
                                          ...
                                          if (r) {
                                              r[1];
                                              for (
                                                  var i = r[2], n = /\[([0-9]+)\]/g, o = [], a = n.exec(i);
                                                  null != a;
...
jQuery(document).on("click", ".gfield_choice--select_all_enabled *", function () {
    var e,
        t = jQuery(this).closest(".gfield_choice--select_all_enabled").find(".gfield_choice_all_toggle");
    jQuery(this).is('.gchoice input[type="checkbox"]') &&
        ...
        jQuery(this).is('.gchoice input[type="checkbox"]') &&
            ...
            (t.is('input[type="checkbox"]') && t.prop("checked", !0), gformToggleSelectAll(t, "deselect"));
});
var GFMergeTag = function () {
        (GFMergeTag.getMergeTagValue = function (e, t, r) {
            ...
            var i = parseInt(t, 10),
                n =
                    (0 < jQuery("#input_" + e + "_" + i + "_copy_values_activated:checked").length &&
                        ((a = jQuery("#input_" + e + "_" + i + "_copy_values_activated").data("source_field_id")),
            ...
            if (!1 === a) {
                ...
                if (
                    1 ===
                    (o = "checkbox" !== o.prop("type") && "radio" !== o.prop("type") ? o : o.filter(":checked")).length
                ) {
                                ...
                                (field.hasClass("gfield_price")
                                    ? (jQuery("#input_" + formId + "_" + formulaField.field_id).text(result),
                                      ...
                                      jQuery(".gfield_label_product").length &&
                                          ...
                                          ((result =
                                              jQuery(
                                                  "label[ for=input_" + formId + "_" + formulaField.field_id + "_1 ]"
                                              )
                            ...
                            ((o = parseInt(n, 10)) == r.field_id && o == n) ||
                                ...
                                d[i][3]
                                    ...
                                    : ((c = jQuery(".gfield_price input[name=input_" + o + "]").is(
                                      ...
                                      (s || c || l) && (a = "price")),
                                (c = (s = !window.gf_check_field_rule || "show" == gf_check_field_rule(e, o, !0, ""))
...
function gformFormatNumber(e, t, r, i) {
    return (
        void 0 === r &&
            (r = window.gf_global ? new gform.Currency(gf_global.gf_currency_config).currency.decimal_separator : "."),
        void 0 === i &&
            (i = window.gf_global ? new gform.Currency(gf_global.gf_currency_config).currency.thousand_separator : ","),
...
function gformValidateFileSize(e, t) {
    var r = (
        0 < jQuery(e).closest("div").siblings(".validation_message").length ? jQuery(e).closest("div") : jQuery(e)
                ...
                t.bind("FilesAdded", function (o, e) {
                    ...
                    0 < l && l <= s
                        ...
                        : (m.each(e, function (e, t) {
                          ...
                          o.refresh(),
                          0 == (t = m("form#gform_" + d + " " + (e = "input:hidden[name='gform_unique_id']"))).length &&
                              (t = m(e)),
                          "" === (r = t.val()) &&
                ...
                t.bind("Error", function (e, t) {
                    ...
                    t.code === plupload.FILE_EXTENSION_ERROR
                        ? ((r = (
                          ...
                          f(e.settings.gf_vars.message_id, t.file.name + " - " + _.invalid_file_extension + " " + r))
...
function gformInitializeSpinner(e, t, r = "gform-ajax-spinner") {
    0 == jQuery("#gform_ajax_spinner_" + e).length &&
        ((r = '<span data-js-spinner-id="' + r + '" id="gform_ajax_spinner_' + e + '" class="gform-loader"></span>'),
        ...
        ? (r = window.tinymce)
            ? (i = r.get("input_" + e + "_" + t))
                ? ((n = jQuery.extend({}, i.settings)),
                  i.remove(),
                  r.init(n),
                  gform.console.log("gformReInitTinymceInstance reinitialized TinyMCE on input_" + e + "_" + t + "."))
                : gform.console.error(
