...
class CKDAImportLogger {
	...
	public function GetElementDescriptionArray($description)
	{
		...
		$arFields = (!is_array($description) ? unserialize(htmlspecialcharsback($description), ['allowed_classes' => false]) : $description);
	...
	public function GetSectionDescription($description, $IBLOCK_ID = false)
	{
		...
		$arFields = unserialize(htmlspecialcharsback($description), ['allowed_classes' => false]);
