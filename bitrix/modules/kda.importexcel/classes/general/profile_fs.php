...
class CKDAImportProfileFS extends CKDAImportProfileAll {
	...
	public function GetList($arFilter=array())
	{
		...
		{
			$arProfiles = unserialize(file_get_contents($this->fileProfiles), ['allowed_classes' => false]);
	...
	public function GetByID($ID)
	{
		...
		{
			$arProfile = unserialize(file_get_contents($fn), ['allowed_classes' => false]);
	...
	public function Copy($ID)
	{
		...
		$arParams = unserialize(file_get_contents($fn), ['allowed_classes' => false]);
