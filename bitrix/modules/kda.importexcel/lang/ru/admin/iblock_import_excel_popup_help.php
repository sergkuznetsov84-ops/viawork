...
$MESS["KDA_IE_FAQ_ANS_CRON"] = "На страницах модуля в правом верхнем углу есть зеленая кнопка \"Настройка cron\". <br>
	...
	<b><i>/home/bitrix/yoursite.com/bitrix/php_interface/include/kda.importexcel/cron_frame.php 0</i></b> - непосредственно запускаемый скрипт. Если у Вас в настройкх хостинга есть пункт типа \"Выполнить php скрипт\", то в строке со скриптом нужно будет вставить только эту часть строки. Здесь \"0\" на конце - это идентификатор профиля импорта.<br>
	<b><i>>/home/bitrix/yoursite.com/bitrix/php_interface/include/kda.importexcel/logs/0.txt</i></b> - путь к файлу с логами импорта. Без указания этого файла Вам в дальнейшем будет сложно отследить результаты импорта по крону.<br><br>						
