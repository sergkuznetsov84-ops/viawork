...
{
	$arParams = unserialize(\Bitrix\Main\Config\Option::get('iblock', 'KDA_IBLOCK'.$IBLOCK_ID.'_PRICEQNT_CONFORMITY'), ['allowed_classes' => false]);
...
foreach($arIblocks as $iblockType=>$iblockId)
{
	...
	{
		$arParams = unserialize(\Bitrix\Main\Config\Option::get('iblock', 'KDA_IBLOCK'.$iblockId.'_PRICEQNT_CONFORMITY'), ['allowed_classes' => false]);
