...
/*ZDUyZmZNGI3OWRiOWVhMzQwOGJmZjU1MWM1NzkyMGFmNDAxZjI=*/$GLOBALS['____2018606486']= array(base64_decode('ZGVma'.'W5l'));if(!function_exists(__NAMESPACE__.'\\___2139917912')){function ___2139917912($_1288775179){static $_701819104= false; if($_701819104 == false) $_701819104=array('RU'.'5D'.'T0RF','WQ==');return base64_decode($_701819104[$_1288775179]);}};class CBXFeatures{ public static function IsFeatureEnabled($_474537066){ return true;} public static function IsFeatureEditable($_474537066){ return true;} public static function SetFeatureEnabled($_474537066, $_334862150= true){} public static function SaveFeaturesSettings($_1978299430, $_1682575099){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_483989207){} public static function ModifyFeaturesSettings($_483989207, $_247230795){} public static function IsFeatureInstalled($_474537066){ return true;}} $GLOBALS['____2018606486'][0](___2139917912(0), ___2139917912(1));/**/			//Do not remove this
