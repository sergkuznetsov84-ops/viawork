...
/**
 * KDAPHPExcel_Writer_Excel2007_Theme
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Writer_Excel2007_Theme extends KDAPHPExcel_Writer_Excel2007_WriterPart
{
	/**
	...
	private static $_majorFonts = array(
					'Jpan' => 'РїС�В­РїС�С– РїС�В°РівЂљТ‘РівЂљВ·РіС“С“РівЂљР‡',
					'Hang' => 'Р»В§вЂ�РјСњР‚ РєС–В Р»вЂќвЂў',
					'Hans' => 'РµВ®вЂ№РґР…вЂњ',
					'Hant' => 'Р¶вЂ“В°Р·Т‘В°Р¶пїЅР‹Р№В«вЂќ',
	 ...
	 */
	public function writeTheme(KDAPHPExcel $pKDAPHPExcel = null)
	{
			// Create XML writer
			$objWriter = null;
	 ...
	 *
	 * @param 	KDAPHPExcel_Shared_XMLWriter	$objWriter
